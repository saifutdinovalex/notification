...
class NotificationsWidget extends Widget
{
    ...
    public $key_id = null;
     ...
     /**
     * @var array An array of jQuery selector to name bell
     */
    public $nameBellClass = [];
    ...
    public function registerAssets()
    {
        ...
        if ($this->key_id) {
            $params['key_id'] = $this->key_id;
        }

        if ($this->nameBellClass) {
            $params['nameBellClass'] = $this->nameBellClass;
        }
